...
>
    <div>
        ...
        <b><?= MgHelpers::getSettingTypeText('Home section 3 - 1 text' . Yii::$app->language, false, 'Inwestycje przyszłości poprzez') ?></b>
        <h1><?= MgHelpers::getSettingTypeText('Home section 3 - 2 text' . Yii::$app->language, false, 'tokenizację nieruchomości') ?></h1>
    </div>
</section>
